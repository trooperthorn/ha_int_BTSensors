...
# Unregistered/vendor-specific manufacturer IDs observed for devices that do
# not have an existing decoder. These are supported today only via the
# generic raw-capture parser (see parsers/generic_raw.py) until a real
# decoder is contributed. See docs/device_identification.md.
